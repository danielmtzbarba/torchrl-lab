...
def make_env(env_id, idx, capture_video, run_name, continuous=False):
    def thunk():
...
if __name__ == "__main__":
    ...
    run_name = f"{args.env_id}-{args.seed}-PPO"
    if args.track:
        import wandb
    ...
    envs = gym.vector.SyncVectorEnv(
        [
            make_env(args.env_id, i, args.capture_video, run_name, continuous=False)
